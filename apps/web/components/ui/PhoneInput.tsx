...
const COUNTRY_CODES = [
  ...
  { code: '+246', country: 'IO', label: 'British Indian Ocean Territory' },
  ...
  { code: '+599', country: 'CW', label: 'Curacao' },
  ...
  { code: '+64', country: 'PN', label: 'Pitcairn' },
  ...
  { code: '+1', country: 'SX', label: 'Sint Maarten' },
  ...
  { code: '+47', country: 'SJ', label: 'Svalbard and Jan Mayen' },
  ...
  { code: '+1', country: 'VI', label: 'U.S. Virgin Islands' },
  ...
  { code: '+39', country: 'VA', label: 'Vatican' },
...
export default function PhoneInput({
  ...
  return (
    <div className={`relative flex rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-orange-500 focus-within:border-orange-500 overflow-hidden transition-colors ${className}`}>
      <div className="flex-shrink-0 relative border-r border-gray-300 bg-gray-50">
        <select
          value={countryCode}
        ...
        <div className="flex items-center justify-center h-full px-3 text-gray-700 text-sm pointer-events-none min-w-[4rem]">
          {countryCode}
          <svg className="w-4 h-4 ml-1 text-gray-500 fill-current" viewBox="0 0 20 20">
      ...
      <input
        ...
        className="w-full px-4 py-3 focus:outline-none text-gray-900 placeholder-gray-400"
